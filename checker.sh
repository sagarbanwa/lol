#!/bin/bash
# LulzSecIndia Present
# Paypal Valid Checker
# 10 October 2017
# By Shiv1337
# Updated postfield
...
printf "$NC\n"
cat <<EOF
             - https://lulzsecindia.com -
          [+] sam65666@gmail.com [+]
        
---------------------------------------------------
    LulzSecIndia - Paypal Email Validator 2017
---------------------------------------------------
...
Report any bugs to: <Shiv1337> contact@sam65666@gmail.com
"
  exit 1 
}
